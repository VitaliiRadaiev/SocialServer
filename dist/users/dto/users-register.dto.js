...
exports.UsersRegisterDto = void 0;
...
__decorate([
    (0, class_validator_1.IsString)({ message: 'Password not specified.' }),
    __metadata("design:type", String)
], UsersRegisterDto.prototype, "password", void 0);
__decorate([
    (0, class_validator_1.IsString)({ message: 'Login not specified.' }),
    __metadata("design:type", String)
], UsersRegisterDto.prototype, "login", void 0);
